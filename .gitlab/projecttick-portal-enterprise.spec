Name:           projecttick-portal-ee
Version:        1.0.5
Release:        1%{?dist}
Summary:        Project Tick Portal Enterprise Edition (Native Runtime)
...
%description
Project Tick Portal Enterprise Edition Self-Contained Engine.
Includes fully optimized bundled PHP, an independent Nginx server,
and MariaDB databases, managed by TickCrypto and projecttick-ctl.
Encrypted Secure Premium Codebase included.
